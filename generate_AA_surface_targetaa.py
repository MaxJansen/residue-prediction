...
def get_close_points(c_dict, surf_dict):
    ...
    for i, c_coord in enumerate(c_dict['xyz']):
        ...
        selected_feats = np.column_stack((selected_feats, angles))
    ...
    # Uncomment this if you want to save point patch per AA, good in pymol
        ...
        select_dir = Path("../dataset/aa_points/cb")
        selected_feats = selected_feats.reshape(20,28)
...
# np.save("../dataset/angle_train_data.npy", data_dict['feat_data'])
# np.save("../dataset/angle_train_target.npy", data_dict['target_type'])
