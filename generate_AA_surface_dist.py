...
np.save("../dataset/expanded_train_data.npy", data_dict['feat_data'])
np.save("../dataset/expanded_train_target.npy", data_dict['target_type'])
print(data_dict['feat_data'][0:10])

 #, inter_coords)
#close_points = get_close_points(ca_dict, surf_dict)
